...
# ===== CONFIG =====
OWNER_IDS = [7808603044, 6299184886, 6439936529, 7328413919, 8451761652, 6340653358]  # Owner IDs

BOT_TOKEN = "8270282529:AAGybnYS-Ix_vHHvo8_gA_Grbswfw8eq01o"
CACHED_FILE = "cached_members.json"


# အရိုးရိုး owner list
OWNERS = [7808603044]  # အလိုလို owner ID တွေ ထည့်နိုင်
OWNER_USERNAMES = ["Problem_Zenki", "TMH657"]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    button1 = InlineKeyboardButton(
        ...
        url="https://t.me/ThaePhyuSpamBot?startgroup=true"
    )

    button2 = InlineKeyboardButton(
        text="👑 𝘉𝘰𝘵 ပိုင်ရှင်",
        url="tg://resolve?domain=TMH657&text="
    )

    button3 = InlineKeyboardButton(
        text="𝑷𝒆𝒓𝒎𝒊𝒔𝒔𝒊𝒐𝒏 တောင်းရန်",
        url="https://t.me/MYAETHAEBOT1/282"
    )

    button4 = InlineKeyboardButton(
        text="𝘉𝘰𝘵 ချန်နယ်",
        url="https://t.me/MYAETHAEBOT1"
    )

    button5 = InlineKeyboardButton(
        text="𝘉𝘰𝘵လိုချင်ရင်နှိိပ်",
        url="tg://resolve?domain=TMH657&text=𝚃𝚑𝚊𝚎𝙿𝚑𝚢𝚞ရေးSpamBotအသစ်လုပ်ချင်လို့ပါ"
    )
